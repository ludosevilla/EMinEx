...
- **emx-0.1.7.com** : Version MSX-DOS "autonome", ne nécessite aucun pilote, compatible avec l’UART 16C550  
- **emx-F0.1.7.com** : Version MSX-DOS pour pilote Fossil, nécessite un pilote Fossil  
- **Version cassette (sans lecteur de disquette installé)** : Voir version 0.1.6
...
- **emx-0.1.7.com** : "Standalone" MSX-DOS version, no need any driver, support UART 16C550  
- **emx-F0.1.7.com** : Fossil driver MSX-DOS version, needs Fossil driver
- **Cassette version (without floppy installed)** : See version 0.1.6
...
- **emx-0.1.7.com** : Versión MSX-DOS "independiente", no requiere ningún controlador, compatible con UART 16C550  
- **emx-F0.1.7.com** : Versión MSX-DOS con controlador Fossil, necesita un controlador Fossil  
- **Versión en cassette (sin disquetera instalada)** : Ver versión 0.1.6
